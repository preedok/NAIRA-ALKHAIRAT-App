...
const createUser = asyncHandler(async (req, res) => {
  ...
  } else if ([ROLES.ROLE_BUS, ROLES.ROLE_HOTEL, ROLES.ADMIN_PUSAT, ROLES.ROLE_ACCOUNTING, ROLES.ROLE_INVOICE_SAUDI, ROLES.ROLE_HANDLING, ROLES.ROLE_SISKOPATUH, ROLES.ROLE_HAJI_DAKHILI].includes(role)) {
    // tidak perlu wilayah
  } else if (branch_id) {
...
const updateUser = asyncHandler(async (req, res) => {
  ...
  if (allowedRoles.includes(currentRole)) {
    ...
    } else if ([ROLES.ROLE_BUS, ROLES.ROLE_HOTEL, ROLES.ADMIN_PUSAT, ROLES.ROLE_ACCOUNTING, ROLES.ROLE_INVOICE_SAUDI, ROLES.ROLE_HANDLING, ROLES.ROLE_SISKOPATUH, ROLES.ROLE_HAJI_DAKHILI].includes(currentRole) && role !== undefined) {
