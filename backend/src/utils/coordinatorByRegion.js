/**
 * Koordinator provinsi & wilayah otomatis berdasarkan provinsi.
 * Digunakan saat create branch - sistem generate otomatis.
 */
...
module.exports = { getCoordinatorForRegion, normalizeRegion };
