...
const { TRAVEL_STATUS } = require('../constants');

const TravelProfile = sequelize.define('TravelProfile', {
  id: {
    type: DataTypes.UUID,
  ...
  status: {
    ...
    allowNull: false,
    defaultValue: TRAVEL_STATUS.PENDING_REGISTRATION_PAYMENT
  },
  address: {
    type: DataTypes.TEXT
  },
  ...
  balance: {
    ...
    allowNull: false,
    defaultValue: 0,
    comment: 'Saldo travel dari pembatalan order (jadikan saldo); dipakai untuk order baru atau alokasi ke tagihan'
  }
}, {
  tableName: 'travel_profiles',
  underscored: true,
  timestamps: true
});

module.exports = TravelProfile;
