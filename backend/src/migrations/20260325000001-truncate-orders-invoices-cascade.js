...
/**
 * Kosongkan semua data order dan invoice dengan TRUNCATE CASCADE.
 * Dipastikan tabel orders dan invoices beserta semua tabel yang mengacu ke mereka terhapus.
 */
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    // Hapus dulu tabel yang punya FK ke invoices/orders (beberapa mungkin tidak auto-cascade)
    ...
    await q.query('UPDATE refunds SET invoice_id = NULL, order_id = NULL WHERE invoice_id IS NOT NULL OR order_id IS NOT NULL');
