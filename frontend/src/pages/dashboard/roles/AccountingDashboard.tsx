...
import { Activity, Receipt, DollarSign, TrendingUp, Building2, MapPin, BarChart3, ChevronRight, X, FileText, Wallet, Landmark, Eye } from 'lucide-react';
        ...
        <div className="p-6 overflow-y-auto flex-1">
          <div className="mb-6">
            <DashboardFilterBar
              ...
              provinces={fWilayah ? provinces.filter((p) => p.wilayah_id === fWilayah) : provinces}
              branches={branches}
            />
          </div>
          {summary && (
    ...
    <div className="space-y-8">
      ...
      >
        <DashboardFilterBar
          ...
          wilayahList={wilayahList}
          provinces={wilayahId ? provinces.filter((p) => p.wilayah_id === wilayahId) : provinces}
          branches={branches}
        />
      </PageFilter>
